...
module.exports = {
    pageMaterialSAP: (req, res) => {
        ...
        (async function () {
            ...
            var lt_materials = await DBModel.getSalesMaterialRFC('ZBAPI_MATERIAL_GETLIST',req.query.pn,req.query.descricao,req.query.familia,req.query.grupo);
