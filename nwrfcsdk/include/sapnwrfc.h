...
typedef struct _RFC_ATTRIBUTES
{
    ...
    SAP_UC reserved[84];			///< Reserved for later use
...
extern "C"
{
	 ...
	 * \ingroup general
	 *
	 * This function has the same effect of the sapnwrfc.ini parameter RFC_TRACE_ENCODING.
	 ...
	 * \ingroup general
	 *
	 * This function has the same effect of the sapnwrfc.ini parameter RFC_TRACE_DIR.
	 * See the documentation of that parameter in the sample ini file contained in the
	 * /demo directory of the NW RFC SDK.
	 *
	 * \note This API call affects only new trace files that will be opened after the call.
	 ...
	 * \out *errorInfo Detail information in case of an invalid traceDir input.
	 * \return RFC_RC
	 */
	 ...
	 * 
	 * 
	 * \in rfcHandle  RFC server connection. If this function is executed on a client connection, RFC_ILLEGAL_STATE will be returnd.
